...
const file_calculator_calculator_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\x01R\x06result2Z\n" +
	"\n" +
	"Calculator\x12L\n" +
	"\tCalculate\x12\x1e.calculator.CalculationRequest\x1a\x1f.calculator.CalculationResponseB@Z>github.com/2760439882/calculator-backend/calculator;calculatorb\x06proto3"
